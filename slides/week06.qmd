...
::: {.fragment}
Tend to be more relatively stable. Why?
:::
...
- Everyone has an interest in government stability $\implies$ Less incentives to overthrow the king
...
- Needs to build support base out of existing social groups and institutions
...
Problems within the ruling elites

- The dictator is initially weak
- He needs a support coalition to rule $\rightarrow$ power-sharing institutions
- But the dictator will likely try to consolidate its power over the coalition
- Example of Stalin: consolidated his power over time by eliminating faction leaders and then purging everybody
- Fearing this, elites in the support coalitions may stage coups, making the regime unstable

## Problems of Authoritarian Power-Sharing

- [Commitment]{.alert} problem of the dictator $\rightarrow$ a promise to share power today can be reneged on tomorrow
- [Monitoring]{.alert} problem $\rightarrow$ elites don't know what the dictator is doing/planning
- [Collective action]{.alert} problem of the elites $\rightarrow$ identify possible successors and share information

Solution: institutions that credibly transfer power to elites (e.g., parliaments, councils, politburos) $\rightarrow$ credibly threaten to punish power grabs of the dictator

Remaining problem: changes in the balance of power can lead to weakening or strengthening of these institutions

(commitment problem may not be fully eliminated)

## Authoritarian Control

Problems between dictator and masses

- Repression $\rightarrow$ trade-off between large-scale repression and empowering the army
- The dictator may want to maintain the army weak and empower internal security services
- This may be a risk if social unrest becomes too large to manage (e.g., Arab Spring)

- Co-optation $\rightarrow$ give access to benefits and resources to organized social groups and make them invested in the regime
- Liberalization without democratization (managed by soft-liners)
- Institutions (e.g., parties) can also solve a credible commitment problem in the distribution of benefits 
...
- Our scientific approach:
  ...
  - Study how ruler's incentives to provide economic goods vary with these institutions
...
:::{.nonincremental}
- **Selectorate** ($S$) $\rightarrow$ group who selects the leder
...
- The dictator needs to redistribute resources to $W$ to stay in power
  ...
  - Larger $W$ $\implies$ public goods (e.g., growth, infrastructures)
  - Economic performance becomes more important if $W$ larger
...
- Members of $W$ choose whether to confirm or withdraw support
  ...
  - $W$ members are more loyal if $W/S$ lower
...
:::{.nonincremental}
- High $W$, high $W/S$ $\rightarrow$ Diffused support and low loyalty require public goods. Good performance
:::
...
- In doing so **familiar problems** emerge
  ...
  - Power-sharing institutions attenuate these problems
