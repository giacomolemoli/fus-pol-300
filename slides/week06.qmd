...
- But the dictator will likely try to consolidate its power over the coalition
  - E.g., Stalin: grabbed absolute power by killing faction leaders and large-scale purges
...
- [Commitment]{.alert} problem of the dictator $\rightarrow$ promise to share power today can be reneged on tomorrow
...
- The dictator may want to maintain the army weak and build up internal security services
...
- Another commitment problem: resource distribution can be stopped once threat of revolt ends
...
- In doing so **familiar problems** emerge
  ...
  - Power-sharing institutions attenuate (but not solve) these problems
