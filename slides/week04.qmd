...
- A scientific approach to the question: isolate core mechanisms
    - Does development alter state-society relationships?
...
- Push winners to moderation and losers to democratic commitment
...
- Rulers anticipate the future evaluation by voters
- Push policies to (perceived) will of the people
...
- Then the government can renege on past promises and expropriate
    - After all, it controls the means of violence
:::
...
$\implies$ Knowing the commitment problem, the bourgeoisie escapes taxation 
...
- **<u>Transfer power to the people</u>** $\rightarrow$ removes temptation to renege by force
    - The ruler will always need consent in the future


---

## Third Step: Democratic Institutions
...
- Parliament $\rightarrow$ control over taxation and royal spending
...
# When Modernization Fails {.section}
...
::: {.fragment .fade-in}
More a precondition than a guarantee
:::
