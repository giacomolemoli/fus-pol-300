...
- Two models: [collective action]{.alert} theory and [tipping]{.alert} model
...
:::{.fragment}
:::{.nonincremental}
- Almost everyone is close to revolting, but Person 1 ($T = 0$) protests alone 
- Highly discontent society, yet only 1 person protests
:::
:::
...
Top-down transition $\rightarrow$ liberalizing reforms lead to democratization

. . . 

Key idea: the government does **not** want to democratize

- Moderate factions ("[soft-liners]{.alert}") $\rightarrow$ support liberal reforms (e.g., freedom of association) to "co-opt" the opposition
