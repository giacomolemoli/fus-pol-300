...
- Making a few people willing to protest can motivate others $\implies$ [revolutionary cascade]{.alert}
...
- Person 1 ($T = 0$) protests alone $\implies$ protest size is 1
- All the others require at least 2 people protesting $\implies$ they stay home
- The cascade fails to start $\rightarrow$ only 1 person revolts!
...
- 9/10 people revolt (except the loyalist)
- A revolutionary cascade is triggered
...
- Person 1 ($T = 0$) revolts alone $\implies$ protest size is 1
- Person 2 ($T = 2$) requires at least 2 people $\implies$ stays home
- No cascade $\rightarrow$ only 1 person revolts
...
- Person 1 ($T = 0$) revolts $\rightarrow$ Person 2 ($T = 1$) joins $\implies$ protest size is 2
- The others require at least 3 people $\implies$ they stay home
- Cascade is blocked by the "gap" at $T = 2$ $\rightarrow$ only 2 people revolt
...
- Without a critical bridge ($T = 1$), no one else joins
- Highly discontented society, yet only 1 person revolts
...
- All 7 individuals with $T = 2$ see their threshold met and join simultaneously
...
::: {.nonincremental}
- Soft-liners mistakenly believe the opposition is **weak** (expecting them to *Enter*)
