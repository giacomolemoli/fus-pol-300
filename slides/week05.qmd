...
- Key problem: the regime wants to concede but not democratize
...
$\implies$ we need to understand the problems of [collective action]{.alert}
...
- The lower **K** is relative to **N** the higher the incentive to free-ride

- In general larger **N** $\implies$ free-rider problem
...
- Absence of protest does not mean support
